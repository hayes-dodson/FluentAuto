...
class HalfCarPipeline:
    ...
    def _mesh(self, session):
        ...
        # Curvature sizing for aero + wheels
        tasks["Add Local Sizing"].AddChildToTask()
        curv = tasks["curvature_all"]
        ...
        mesh = os.path.join(self.outdir, "mesh_hc.msh.h5")
    ...
    def _solve(self, mesh):
        ...
        solver.solution.RunCalculation.iterate(8000)
